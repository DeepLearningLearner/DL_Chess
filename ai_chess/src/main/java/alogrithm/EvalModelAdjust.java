...
public class EvalModelAdjust {
    ...
    int[][] zPosition = new int[][]{
            {0, 3, 6, 9, 12, 9, 6, 3, 0},
            {18, 25, 40, 50, 60, 50, 40, 35, 18},
            {14, 20, 30, 40, 50, 40, 30, 20, 14},
            ...
            switch (piece.character) {
                ...
                case 's':
                    if (piece.color == 'r'){
                        ...
                        values[0][1] += evalPiecePosition(7, piece.position);
                    }
    ...
    private int evalPieceValue(int p) {
        /* b | s | x | m | j | p | z*/
        int[] pieceValue = new int[]{1000000, 220, 200, 600, 1200, 600, 100};
    ...
    private int evalPiecePosition(int p, int[] pos) {
        ...
        if (p== 7)  return this.xsPosition[pos[0]][pos[1]];
        return -1;
    }

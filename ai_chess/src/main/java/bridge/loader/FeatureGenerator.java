...
public class FeatureGenerator {
    ...
    public static double[] getAllFeature(Board board){
        double[] resultList = new double[maxFeature1() + maxFeature2() + maxFeature3() + maxFeature4() + maxFeature5()];


        // 特征1.
        double[] feature1 = getFeature1(board);
        for(int i = 0; i < feature1.length; i++){
            resultList[i] = feature1[i];
        }

        // 特征2.
        double[] feature2 = getFeature2(board);
        for(int i = 0; i < feature2.length; i++){
            resultList[i + maxFeature1()] = feature2[i];
        }

        // 特征3.
        double[] feature3 = getFeature3(board);
        for(int i = 0; i < feature3.length; i++){
            resultList[i + maxFeature1() + maxFeature2()] = feature3[i];
        }

        // 特征4.
        double[] feature4 = getFeature4(board);
        for(int i = 0; i < feature4.length; i++){
            resultList[i + maxFeature1() + maxFeature2() + maxFeature3()] = feature4[i];
        }
...
//
    ...
    public static int[] getAllFeatureIndex(Board board){
        LinkedList<Integer> resultList = new LinkedList<Integer>();

        // 特征一。
        int[] feature1 = getFeature1Index(board);
        for(int i = 0; i < feature1.length; i++){
            resultList.add(feature1[i]);
        }

        // 特征2.
        int[] feature2 = getFeature2Index(board);
        for(int i = 0; i < feature2.length; i++){
            resultList.add(feature2[i] + maxFeature1());
        }

        // 特征3.
        int[] feature3 = getFeature3Index(board);
        for(int i = 0; i < feature3.length; i++){
            resultList.add(feature3[i] + maxFeature1() + maxFeature2());
        }

        // 特征4.
        int[] feature4 = getFeature4Index(board);
        for(int i = 0; i < feature4.length; i++){
            resultList.add(feature4[i] + maxFeature1() + maxFeature2() + maxFeature3());
        }
